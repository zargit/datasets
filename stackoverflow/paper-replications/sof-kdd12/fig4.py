...
q1 = qa[qa['timerank'] == 1]
q2 = qa[qa['timerank'] == 2]
qq = pd.merge(q1[['id_q', 'id_a', 'timerank', 'reputation_a']], q2[['id_q', 'id_a', 'timerank', 'reputation_a']], how='inner', on='id_q', suffixes=['_1', '_2'])
print(qq.columns)
data = qq[['id_q', 'id_a_1', 'id_a_2', 'reputation_a_1', 'reputation_a_2', 'timerank_1', 'timerank_2']]
...
data.to_csv('fig4.csv', index=False)
